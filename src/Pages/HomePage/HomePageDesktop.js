...
import AvailableTodayDesktop from './AvailableTodayDesktop'
...
const HomePageDesktop = (props) => {
    ...
    return (
        <div>
            ...
            <AvailableTodayDesktop name_1='Foody Magic' name_2='Tasty Rice' type_1='Italian' type_2='Chinese' offer='20% off entire order today' image_1={require('../../assets/h.png')} image_2={require('../../assets/taste.png')} />

            <CategoryHeading CategoryName='Hair Salon' onPress={viewAll} ViewAll='View all' />
            <AvailableTodayDesktop name_1='Sana Salon' name_2='Tariq Salon' type_1='Woman' type_2='Men' offer='40% off entire order today' image_1={require('../../assets/hair1.png')} image_2={require('../../assets/hair.png')} />

            <CategoryHeading CategoryName='Gym' onPress={viewAll} ViewAll='View all' />
            <AvailableTodayDesktop name_1='24 Hours Gym' name_2='24 Hours Gym' type_1='Gym' type_2='Gym' offer='25% off entire order today' image_1={require('../../assets/gym1.png')} image_2={require('../../assets/gym2.png')} />
